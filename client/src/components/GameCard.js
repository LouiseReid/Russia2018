...
class GameCard extends React.Component {
  ...
  render(){
    ...
    const { round, location, home_team, away_team, home_goals, away_goals, home_tactics, away_tactics, home_yellow, away_yellow, home_red, away_red, home_possession, away_possession, home_attempts, away_attempts, home_fouls, away_fouls, extra_time, penalties, hints } = this.props.game
